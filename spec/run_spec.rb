decribe Run do
  describe "attributes" do
    subject do
      Run.new(duration: 32, distance: 5.2, timestamp: "2014-12-22 20:30")
    end
...
describe RunningWeek do
  describe ".count" do
    context "with 2 logged runs this week and 1 in the next" do
      before do
        2.times do
          Run.log(duration: rand(10), distance: rand(8), timestamp: "2015-01-12 20:30")
        end
        Run.log(duration: rand(10), distance: rand(8), timestamp: "2015-01-19 20:30")
      end
  ...
  let(:wednesday_run) do
    Run.new(duration: 32, distance: 5.2, timestamp: "2015-01-14 19:50")
  end
